...
public class RivShsRouteBuilder extends RouteBuilder {
    ...
    public void configure() throws Exception {
        ...
        from("{{rivInBridgeEndpoint}}{{rivInBridgePathPrefix}}").routeId("riv2shs")
                ...
                .setProperty(ShsHeaders.TO, header(ShsHeaders.TO)) //must be saved during whole exchange
                ...
                .setHeader(ShsHeaders.STATUS, method("rivShsMapper", "mapRivShsLabelStatus"))   
                .choice().when(header(ShsHeaders.STATUS).isEqualTo("default"))
